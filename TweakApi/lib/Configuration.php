...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/1.0.3-alpha.11/php";
    ...
    {
        $report  = 'PHP SDK (Tweak\Api) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.0.3-alpha.15' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.3-alpha.11' . PHP_EOL;
