...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/1.0.6-alpha.3/php";
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    OpenAPI Spec Version: 1.0.6-alpha.2' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.6-alpha.3' . PHP_EOL;
