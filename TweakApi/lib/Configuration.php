...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/1.0.2-alpha.6/php";
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    OpenAPI Spec Version: 1.0.2-alpha.12' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.2-alpha.6' . PHP_EOL;
