...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/1.0.4-alpha.1/php";
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    OpenAPI Spec Version: 1.0.4-alpha.1' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.4-alpha.1' . PHP_EOL;
