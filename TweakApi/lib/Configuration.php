...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/1.0.8-alpha.4/php";
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    OpenAPI Spec Version: 1.0.8-alpha.10' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.8-alpha.4' . PHP_EOL;
