...
/**
 * PublicVAuthApi Class Doc Comment
 *
 * @category Class
 * @package  Tweak\Api
 * @author   http://github.com/swagger-api/swagger-codegen
...
class PublicVAuthApi
{
     ...
     */
    public function v1AuthValidateGet()
    {
        list($response) = $this->v1AuthValidateGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation v1AuthValidateGetWithHttpInfo
     *
     * Validate authentication
     *
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function v1AuthValidateGetWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/v1/Auth/validate";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
