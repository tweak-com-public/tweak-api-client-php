...
class MessageApi
{
     ...
     */
    public function messageGreet($msg = null)
    {
        list($response) = $this->messageGreetWithHttpInfo($msg);
        return $response;
    }

    /**
     * Operation messageGreetWithHttpInfo
     *
     * 
     *
     * @param string $msg  (optional)
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function messageGreetWithHttpInfo($msg = null)
    {
        // parse inputs
        $resourcePath = "/Messages/greet";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
