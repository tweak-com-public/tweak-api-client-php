...
class PublicVTeamApi
{
    ...
    /**
     * Operation v1TeamBuilderConfigsDefaultProductSizeMaterialsGet
     *
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function v1TeamBuilderConfigsDefaultProductSizeMaterialsGet()
    {
        list($response) = $this->v1TeamBuilderConfigsDefaultProductSizeMaterialsGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation v1TeamBuilderConfigsDefaultProductSizeMaterialsGetWithHttpInfo
     *
     * Get default Team's BuilderConfig ProductSizeMaterial
     *
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function v1TeamBuilderConfigsDefaultProductSizeMaterialsGetWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/v1/Team/builderConfigs/default/productSizeMaterials";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/v1/Team/builderConfigs/default/productSizeMaterials'
            );
    ...
    /**
     * Operation v1TeamBuilderConfigsIdProductSizeMaterialsGet
     *
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function v1TeamBuilderConfigsIdProductSizeMaterialsGet($id)
    {
        list($response) = $this->v1TeamBuilderConfigsIdProductSizeMaterialsGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation v1TeamBuilderConfigsIdProductSizeMaterialsGetWithHttpInfo
     *
     * Get Team's BuilderConfig ProductSizeMaterial by BuilderConfig id
     *
     * @param string $id BuilderConfig id (required)
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function v1TeamBuilderConfigsIdProductSizeMaterialsGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1TeamBuilderConfigsIdProductSizeMaterialsGet');
        }
        // parse inputs
        $resourcePath = "/v1/Team/builderConfigs/{id}/productSizeMaterials";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/v1/Team/builderConfigs/{id}/productSizeMaterials'
            );
