...
class TeamBuilderConfigApi
{
    ...
    /**
     * Operation teamBuilderConfigsGlobalGet
     *
     * Reset Team keys
     *
     * @return \Swagger\Client\Model\TeamBuilderConfig
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function teamBuilderConfigsGlobalGet()
    {
        list($response) = $this->teamBuilderConfigsGlobalGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation teamBuilderConfigsGlobalGetWithHttpInfo
     *
     * Reset Team keys
     *
     * @return array of \Swagger\Client\Model\TeamBuilderConfig, HTTP status code, HTTP response headers (array of strings)
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function teamBuilderConfigsGlobalGetWithHttpInfo()
    {
        // parse inputs
