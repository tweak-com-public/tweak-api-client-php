...
class CustomerApi
{
    ...
    /**
     * Operation customersIdTeamsNkDynamicDatasDelete
     *
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function customersIdTeamsNkDynamicDatasDelete($id, $nk)
    {
        list($response) = $this->customersIdTeamsNkDynamicDatasDeleteWithHttpInfo($id, $nk);
        return $response;
    }

    /**
     * Operation customersIdTeamsNkDynamicDatasDeleteWithHttpInfo
     *
     * Deletes all dynamicDatas of this model.
     *
     * @param string $id Customer id (required)
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function customersIdTeamsNkDynamicDatasDeleteWithHttpInfo($id, $nk)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling customersIdTeamsNkDynamicDatasDelete');
        }
        // verify the required parameter 'nk' is set
        if ($nk === null) {
            throw new \InvalidArgumentException('Missing the required parameter $nk when calling customersIdTeamsNkDynamicDatasDelete');
        }
        // parse inputs
