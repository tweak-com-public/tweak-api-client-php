...
class TeamMemberApi
{
    ...
    /**
     * Operation teamMembersIdTeamBillingDelete
     *
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function teamMembersIdTeamBillingDelete($id)
    {
        list($response) = $this->teamMembersIdTeamBillingDeleteWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation teamMembersIdTeamBillingDeleteWithHttpInfo
     *
     * Deletes billing of this model.
     *
     * @param string $id TeamMember id (required)
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function teamMembersIdTeamBillingDeleteWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling teamMembersIdTeamBillingDelete');
        }
        // parse inputs
    ...
    /**
     * Operation teamMembersIdTeamBillingGet
     *
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function teamMembersIdTeamBillingGet($id, $refresh = null)
    {
        list($response) = $this->teamMembersIdTeamBillingGetWithHttpInfo($id, $refresh);
        return $response;
    }

    /**
     * Operation teamMembersIdTeamBillingGetWithHttpInfo
     *
     * Fetches hasOne relation billing.
     *
     * @param string $id TeamMember id (required)
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function teamMembersIdTeamBillingGetWithHttpInfo($id, $refresh = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling teamMembersIdTeamBillingGet');
        }
        // parse inputs
        $resourcePath = "/TeamMembers/{id}/team/billing";
        $httpBody = '';
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function teamMembersIdTeamBillingPost($id, $data = null)
    {
        list($response) = $this->teamMembersIdTeamBillingPostWithHttpInfo($id, $data);
        return $response;
    }

    /**
     * Operation teamMembersIdTeamBillingPostWithHttpInfo
     *
     * Creates a new instance in billing of this model.
     *
     * @param string $id TeamMember id (required)
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function teamMembersIdTeamBillingPostWithHttpInfo($id, $data = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling teamMembersIdTeamBillingPost');
        }
        // parse inputs
        $resourcePath = "/TeamMembers/{id}/team/billing";
        $httpBody = '';
