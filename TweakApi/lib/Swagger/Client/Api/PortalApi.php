...
class PortalApi
{
    ...
    /**
     * Operation portalsIdBuilderConfigDefaultGet
     *
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function portalsIdBuilderConfigDefaultGet($id)
    {
        list($response) = $this->portalsIdBuilderConfigDefaultGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation portalsIdBuilderConfigDefaultGetWithHttpInfo
     *
     * Get default TeamBuilderConfig for this Portal
     *
     * @param string $id Portal id (required)
    ...
    /**
     * Operation portalsIdDefaultBuilderConfigGet
     *
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function portalsIdDefaultBuilderConfigGet($id, $refresh = null)
    {
        list($response) = $this->portalsIdDefaultBuilderConfigGetWithHttpInfo($id, $refresh);
        return $response;
    }

    /**
     * Operation portalsIdDefaultBuilderConfigGetWithHttpInfo
     *
     * Fetches belongsTo relation defaultBuilderConfig.
     *
     * @param string $id Portal id (required)
     ...
     * @throws \Tweak\Api\ApiException on non-2xx response
     */
    public function portalsIdDefaultBuilderConfigGetWithHttpInfo($id, $refresh = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling portalsIdDefaultBuilderConfigGet');
        }
        // parse inputs
        $resourcePath = "/Portals/{id}/defaultBuilderConfig";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Swagger\Client\Model\TeamBuilderConfig',
                '/Portals/{id}/defaultBuilderConfig'
            );
